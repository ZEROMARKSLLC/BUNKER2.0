...
| | |
| :---: | :---: |
| <img src="img/01-access.png" width="420" alt="BUNKER ACCESS login screen with ASCII-art bunker and master-password prompt" /> <br/> **Login** — the vault door, with attempt tracking | <img src="img/02-main-menu.png" width="420" alt="Main menu listing accounts, notes, generator, and system info" /> <br/> **Main Menu** — everything is two keystrokes away |
| <img src="img/03-account-manager.png" width="420" alt="Account manager listing saved profiles with view and copy options" /> <br/> **Password Manager** — view, copy, edit, organize | <img src="img/05-notes.png" width="420" alt="Notes manager showing encrypted notes with tags" /> <br/> **Encrypted Notes** — tagged, private-flagged secure notes |
| <img src="img/06-generator.png" width="420" alt="Password generator showing a newly generated strong password" /> <br/> **Generator** — CSPRNG-backed passwords on demand | <img src="img/07-self-destruct.png" width="420" alt="Self-destruct nuke screen shown after failed login attempts" /> <br/> **Self-Destruct** — the burner vault means business |
