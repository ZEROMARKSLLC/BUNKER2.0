    ...
    try:
        ...
        while True:
            ...
            # Generate new salt and key
                ...
                # Snapshot the live files so ANY exception below can restore
                # the vault to its pre-rotation state immediately. The .bak
                # files still cover hard crashes; this rollback covers plain
                # errors without requiring login-time recovery.
                pre_rotation = {}
                ...
                # Rotation complete. Remove old-key .bak files so a
                # compromised old password cannot decrypt the backups.
